            ...
            <div class="single-page-content">
                <article class="hentry">
                    ...
                    <div class="style-post video">
                                      ...
                                      foreach ($match as $matc) {
                                          if(isset($matc[0])){
                                            if(wp_oembed_get($matc[0])){
                                                ...
                                                echo '<div class="cactus-light"><i class="fa fa-lightbulb-o"></i></div>';
                                            }
                                          }
                                      }
                                  }
                        ...
                        <div class="fixed-video-background"></div>
                    </div>
                    <!-- style-post Video-->
                    ...
                    <div class="body-content">
                        ...
                        if(get_post_format()=='video' || get_post_format()=='audio'){
                            ...
                            foreach ($match[0] as $amatch) {
                                if(strpos($amatch,'youtube.com') !== false || strpos($amatch,'youtu.be') !== false || strpos($amatch,'vimeo.com') !== false || strpos($amatch,'soundcloud.com') !== false){
